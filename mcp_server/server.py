"""
Standalone MCP server exposing the Jewish book guide tools.
Runs via stdio transport; consumed by the LangGraph agent using langchain_mcp_adapters.
"""
